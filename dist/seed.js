...
const complaint_model_1 = require("./modules/complaint/complaint.model");
const notice_model_1 = require("./modules/notice/notice.model");
const payment_model_1 = require("./modules/payment/payment.model");
const seed = async () => {
    try {
        await (0, db_1.connectDB)();
        console.log("🧹 Clearing database collections...");
        await student_model_1.User.deleteMany({});
        await room_model_1.Room.deleteMany({});
        await booking_model_1.Booking.deleteMany({});
        await complaint_model_1.Complaint.deleteMany({});
        await notice_model_1.Notice.deleteMany({});
        await payment_model_1.Payment.deleteMany({});
        console.log("✅ Database cleared.");
        console.log("👤 Seeding admin user...");
        const admin = await student_model_1.User.create({
        ...
        for (const s of studentsData) {
            const student = await student_model_1.User.create({
                ...s,
                role: "student",
        ...
        for (const n of noticesData) {
            await notice_model_1.Notice.create({
                ...n,
        ...
        for (const c of complaintsSpecs) {
            await complaint_model_1.Complaint.create({
